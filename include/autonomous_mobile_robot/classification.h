...
// #include <autonomous_mobile_robot/CompressedSensorData.h>
...
#include <autonomous_mobile_robot/classificationConfig.h>
//クラスの定義
class classificationClass{
    private:
        ...
        autonomous_mobile_robot::SensorMapData smdCamera, smdLRF;
        //送信データ
		ros::NodeHandle nhPub;
        ros::Publisher pub;
        autonomous_mobile_robot::ClassificationData cd;
        //クラスタリング処理
        // std::vector<int> mapIndex;//
    	std::vector<int> winIndex;//基準点（コア点）から参照値
        // autonomous_mobile_robot::CompressedSensorData compCamData;
        //--カメラパラメータ
        ...
        dynamic_reconfigure::Server<autonomous_mobile_robot::classificationConfig> server;
        dynamic_reconfigure::Server<autonomous_mobile_robot::classificationConfig>::CallbackType f;
    public:
        //in constracter.cpp
        ...
        void cameraMap_callback(const autonomous_mobile_robot::SensorMapData::ConstPtr& msg);
        void subscribeSensorDataLRF();//データ受信
        void laserMap_callback(const autonomous_mobile_robot::SensorMapData::ConstPtr& msg);
        //--rqt_reconfigureからの読み込み
        void configCallback(autonomous_mobile_robot::classificationConfig &config, uint32_t level);
        //--クラスタリング
