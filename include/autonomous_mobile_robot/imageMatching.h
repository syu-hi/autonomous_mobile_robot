...
//self msg
#include <autonomous_mobile_robot/MaskImageData.h>
#include <autonomous_mobile_robot/ImageMatchingData.h>
// rqt_reconfige
#include <dynamic_reconfigure/server.h>
#include <autonomous_mobile_robot/imageMatchingConfig.h>
//debug
...
class imageMatchingClass{
    private:
        ...
        autonomous_mobile_robot::MaskImageData midPre,midCur;
        ...
        dynamic_reconfigure::Server<autonomous_mobile_robot::imageMatchingConfig> server;
        dynamic_reconfigure::Server<autonomous_mobile_robot::imageMatchingConfig>::CallbackType f;
    ...
    public:
        ...
        //セット：内部パラメータの書き込み
        void setLaunchParam();
        void configCallback(autonomous_mobile_robot::imageMatchingConfig &config, uint32_t level);
        //ゲット：内部パラメータの読み込み
        int& getParam();//(未使用)
        //
        //in methods.cpp
        ...
        void maskImage_callback(const autonomous_mobile_robot::MaskImageData::ConstPtr& msg);//データ受信(mask画像)
        //--グレースケール化
        void cvtGray();
        //--データ確認
