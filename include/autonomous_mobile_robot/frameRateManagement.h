...
#include<autonomous_mobile_robot/synchronizedImage.h>
...
class managementClass{
    private:
        ...
        autonomous_mobile_robot::synchronizedImage syncImg;
        //送信データ
    ...
    public:
        ...
        //--センサーデータ受信
        void subscribeData();
        void callback(const autonomous_mobile_robot::synchronizedImage::ConstPtr& imageMsg);
        //--データ重複チェック
        void checkDuplication(const autonomous_mobile_robot::synchronizedImage::ConstPtr& imageMsg);
        //データ送信
        ...
        void delayTime();
        void culcPastTime();
        void culcDifTime(const autonomous_mobile_robot::synchronizedImage::ConstPtr& imageMsg);
