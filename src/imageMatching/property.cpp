#include<autonomous_mobile_robot/imageMatching.h>
...
void imageMatchingClass::configCallback(autonomous_mobile_robot::imageMatchingConfig &config, uint32_t level) {
