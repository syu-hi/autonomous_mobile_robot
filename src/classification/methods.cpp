#include<autonomous_mobile_robot/classification.h>

//subscribe
void classificationClass::subscribeSensorDataCamera(){//Cameraデータ受信
	queue1.callOne(ros::WallDuration(1));
}
void classificationClass::cameraMap_callback(const autonomous_mobile_robot::SensorMapData::ConstPtr& msg)
{
    //データをコピー
    smdCamera = *msg;
	//move manage method
...
void classificationClass::laserMap_callback(const autonomous_mobile_robot::SensorMapData::ConstPtr& msg)
{
    //データをコピー
